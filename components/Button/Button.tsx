...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-xs sm:text-[12px] font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        primary:
        ...
        ghost: 'hover:bg-gray-100 text-gray-700 hover:text-gray-900 transition-colors',
        link: 'text-primary underline-offset-4 hover:underline',
        document: 'bg-white p-2 text-primary-600 border border-primary-200 hover:border-primary-400 hover:bg-primary-50/50',
      },
      size: {
